...
export declare const QA_ASSISTANT_LOCAL_URL = "https://local-qa-assistant.flagship.io/bundle.js";
 ...
 * Message Info
 */
export declare const SDK_STARTED_INFO = "Flagship SDK (version: {0}) {1}";
 ...
 * Message Error
 */
export declare const INITIALIZATION_PARAM_ERROR: string;
...
export declare const NEW_VISITOR_NOT_READY: string;
...
export declare const CONTEXT_KEY_ERROR: string;
export declare const CONTEXT_VALUE_ERROR: string;
export declare const PREDEFINED_CONTEXT_TYPE_ERROR: string;
...
export declare const VISITOR_EXPOSED_VALUE_NOT_CALLED = "Visitor \"{0}\", the flag with the key \"{1}\" has been exposed without calling the `getValue` method first.";
export declare const FLAG_VISITOR_EXPOSED = "FLAG_VISITOR_EXPOSED";
export declare const USER_EXPOSED_CAST_ERROR = "For the visitor \"{0}\", the flag with key \"{1}\" has been exposed despite having a different type compared to the default value";
...
export declare const METADATA_SDK_NOT_READY: string;
export declare const METADATA_PANIC_MODE: string;
...
export declare const VISITOR_AUTHENTICATE_VISITOR_ID_ERROR: string;
...
export declare const LOOKUP_VISITOR_JSON_OBJECT_ERROR: string;
